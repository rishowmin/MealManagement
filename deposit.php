                    ...
                    <div class="container-fluid">
                        <div class="row page-title-header mt-3 mb-4">
                            ...
                            <div class="col-md-6 breadcrumb-custom-cls">
                                <ol class="breadcrumb breadcrumb-custom ml-auto">
                                    <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-cls">Dashboard</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="row card-body">
                                <div class="col-md-6 add-btn-label">
                                    <i class="fas fa-plus-circle"></i>
                                    <b>Add A New Deposit</b>
                                </div>
                                <div class="col-md-6 add-btn-div">
                                    <a href="add-deposit.php" class="add-btn">Add</a>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-4">
                            <form method="post">
                                <div class="row card-header">
                                    ...
                                    <div class="col-md-4 input-group">
                                        ...
                                        <input type="month" class="form-control" id="month" name="month_selector">
                                    </div>

                                    <div class="col-md-2 filter-btn">
                                        <button class="btn btn-primary ml-2" type="submit" name="search"><i class="fas fa-filter"></i> Filter</button>
                                    </div>

                                    <div class="col-md-6 selected-month">                                                                          
                                        <!-- <h4 name="month_select"><i class="fas fa-calendar"></i></h4> -->
                                        <b> <i class="fas fa-calendar"></i> January 2021 </b>
                                    </div>
